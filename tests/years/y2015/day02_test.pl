...
test('part1("2x3x4") = 58') :- run(aoc:part1, '2015/day02', "2x3x4", 58).
test('part1("1x1x10") = 43') :- run(aoc:part1, '2015/day02', "1x1x10", 43).
test('part1("2x3x4\n1x1x10") = 101') :- run(aoc:part1, '2015/day02', "2x3x4\n1x1x10", 101).
...
test('part2("2x3x4") = 34') :- run(aoc:part2, '2015/day02', "2x3x4", 34).
test('part2("1x1x10") = 14') :- run(aoc:part2, '2015/day02', "1x1x10", 14).
